...
> 3. After sending the application form, submit an access request on the [**Hugging Face model page**](https://huggingface.co/MightyAntsGoesUp/Med-Shicheng-1.5B-Base).  
>  
